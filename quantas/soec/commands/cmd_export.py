...
from ..utils.export import QuantasSOECExport


@click.command('soec')
@click.argument('filename', type=click.Path(exists=True))
def soec_export(filename):
    """ Export results obtained from SOEC analysis.

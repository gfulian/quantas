...
class QHATableFile():
    ...
    types = {
        ...
        'P': {'desc': 'Pressure', 'label': 'P ({})', 'numstyle': ptype},
        ...
        'Cv': {'desc': 'Isochoric heat capacity', 'label': 'Cv ({})',
               'numstyle': etype},
        'VT': {'desc': 'Unit cell volume', 'label': 'V ({}^3)',
               'numstyle': vtype},
        'Cp': {'desc': 'Isobaric heat capacity', 'label': 'Cp ({})',
               'numstyle': etype},
        'Cp-Cv': {'desc': 'Correction for isobaric heat capacity','label':
                  'Cp-Cv ({})', 'numstyle': etype},
        'KT': {'desc': 'Isothermal bulk modulus', 'label': 'KT ({})',
               'numstyle': ptype},
        'KS': {'desc': 'Adiabatic bulk modulus', 'label': 'KS ({})',
               'numstyle': ptype},
        'Kp': {'desc': 'First-derivative of bulk modulus', 'label': "K'{}",
               'numstyle': ptype},
        'alphaV': {'desc': 'Volumetric coefficient of thermal expansion',
                   'label': 'alphaV ({})', 'numstyle': etype},
        'H': {'desc': 'Enthalpy', 'label': 'H ({})', 'numstyle': etype},
        'G': {'desc': 'Gibbs free energy', 'label': 'G ({})',
              'numstyle': etype},
        'gruneisen': {'desc': 'Gruneisen parameters', 'label': 'gamma',
               'numstyle': etype},
        }
    def __init__(self):
        return
